       ...
       <div className='flex justify-around bg-gray-200 items-start w-full '>
              ...
              <div className='rounded-3xl w-96 p-5  flex flex-col items-center pb-16'>
                <div className="  flex items-center px-5 gap-x-2">
                        ...
                        <NavLink to="/" className="text-green-600 text-2xl font-sans font-bold ">
                          momo
                        </NavLink>
                      </div>
                      <p className='text-black-600 ml-10 mt-4'> Lorem ipsum dolor sit amet consectetur adipisicing <br/>elit. Incidunt voluptatum nesciunt voluptate illum <br/>aliquid quaerat enim explicabo beatae pariatur?<br/> Earum tenetur dolores labore rerum accusantium <br/>recusandae eius impedit voluptates sunt!</p>
              ...
              <div className=' rounded-3xl w-96 p-5  flex flex-col items-center pb-16'>
                ...
                <h2 className='text-2xl font-semibold text-green-600'>Follow Us </h2>
